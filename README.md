...
Build production-ready extensions for Blueprin without reimplementation its core infrastructure.
...
|---|---|---|
| Plugin execution | Enabled | Lifecycle controlled |
| External network | Disabled | Allowlist required |
| Hooks | Enabled | 200ms timeout |
| Storage | Restricted | Adapter controlled |
| UI | Enabled | React sandbox |
